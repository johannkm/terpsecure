! function e(a, r, o) {
    ...
    12: [function(e, a, r) {
        ...
        var o = e("hsimp-library"),
            ...
            t = function(e) {
                ...
                var y = "bad";
                return p.isInsecure() ? (y = "insecure", l = 0, h = "Instantly") : l >= s.good ? y = p.hasWarnings() ? "ok" : "good" : l >= s.ok && (y = "ok"), a.getSecurityLevel = o.output(y), a.getPossibleCombinations = o.output(t), a.getTimeInSeconds = o.output(l), a.getString = o.output(h), a.getTimeString = o.output(h), a
            };
    ...
    16: [function(e, a, r) {
        ...
        var o, n, i = e("hsimp-library"),
            s = i.prop("seconds"),
            t = function(e) {
                return e = e || "second", e = e.toLowerCase(), o.hasOwnProperty(e) ? o[e] : null
            },
            l = function(e) {
                var a, r = i.prop(0, n);
            ...
            var a = function(a) {
                ...
                r = function(a) {
                    var r = e("<h4 />").text(a.name).addClass("hsimp-check__header"),
                        o = e("<p />").text(a.message).addClass("hsimp-check__message").hide(),
                        n = e("<li />").append(r, o).addClass("hsimp-check--" + a.level).addClass("hsimp-results__check");
                    return n.on("mouseenter", function() {
                        o.slideDown()
                ...
                s = function(i, s) {
                    ...
                    var l = a(t).hide();
                    t.after(l);
                    var c = e("<p />").addClass("hsimp-results__time"),
                        d = e("<span />"),
                        m = e("<ul />").addClass("hsimp-results__checks");
                    c.append(e("<strong/ >").text("Time to crack: "), d), l.append(c, m);
                    var u = !1;
                    t.on("keyup", function() {
                        var e = t.val(),
                            a = o(e);
